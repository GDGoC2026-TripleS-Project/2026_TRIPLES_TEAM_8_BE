...
public class FeedController {
    ...
    @Operation(summary = "탐색 피드 조회 (비회원/공통)", description = "카테고리와 키워드로 도서 목록을 필터링하여 페이징 조회합니다.")
    @ApiResponses({
    ...
    @GetMapping("/explore")
    public ResponseEntity<ApiResponseTemplate<Page<BookDetailResponse>>> getBooks(
